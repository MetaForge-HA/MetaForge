"""Temporal activity wrapper for the Simulation Engineering agent."""
...
tracer = get_tracer("orchestrator.activities.simulation")
...
@_activity_defn
async def run_simulation_agent(input: AgentActivityInput) -> AgentActivityOutput:
    """Run the Simulation Engineering agent as a Temporal activity."""
    with tracer.start_as_current_span("activity.run_simulation_agent") as span:
