"""Temporal activity wrapper for the Electronics Engineering agent."""
...
tracer = get_tracer("orchestrator.activities.electronics")
...
@_activity_defn
async def run_electronics_agent(input: AgentActivityInput) -> AgentActivityOutput:
    """Run the Electronics Engineering agent as a Temporal activity."""
    with tracer.start_as_current_span("activity.run_electronics_agent") as span:
        ...
        try:
            ...
            logger.info(
                "electronics_activity_completed",
                run_id=input.run_id,
                step_id=input.step_id,
